  ...
  \********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! C:\DatingApp\client\src\polyfills.ts */ "hN/g"
        );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function (factory) {
          ...
          const Zone$1 = (function (global) {
            ...
            const symbolPrefix =
              global["__Zone_symbol_prefix"] || "__zone_symbol__";
            function __symbol__(name) {
              return symbolPrefix + name;
            }
            const checkDuplicate =
              global[__symbol__("forceDuplicateZoneCheck")] === true;
            if (global["Zone"]) {
            ...
            class Zone {
              ...
              wrap(callback, source) {
                ...
                const _callback = this._zoneDelegate.intercept(
                  this,
                  callback,
                  source
                );
            ...
            const DELEGATE_ZS = {
              name: "",
              onHasTask: (delegate, _, target, hasTaskState) =>
                delegate.hasTask(target, hasTaskState),
              onScheduleTask: (delegate, _, target, task) =>
                delegate.scheduleTask(target, task),
              onInvokeTask: (delegate, _, target, task, applyThis, applyArgs) =>
                delegate.invokeTask(target, task, applyThis, applyArgs),
              onCancelTask: (delegate, _, target, task) =>
            ...
            class ZoneDelegate {
              constructor(zone, parentDelegate, zoneSpec) {
                ...
                this._forkCurrZone =
                  zoneSpec &&
                  (zoneSpec.onFork ? this.zone : parentDelegate._forkCurrZone);
                this._interceptZS =
                  zoneSpec &&
                  (zoneSpec.onIntercept
                    ? zoneSpec
                    : parentDelegate._interceptZS);
                this._interceptDlgt =
                  zoneSpec &&
                  (zoneSpec.onIntercept
                    ? parentDelegate
                    : parentDelegate._interceptDlgt);
                this._interceptCurrZone =
                  zoneSpec &&
                  (zoneSpec.onIntercept
                    ? this.zone
                    : parentDelegate._interceptCurrZone);
                this._invokeZS =
                  zoneSpec &&
                  (zoneSpec.onInvoke ? zoneSpec : parentDelegate._invokeZS);
                this._invokeDlgt =
                  zoneSpec &&
                  (zoneSpec.onInvoke
                    ? parentDelegate
                    : parentDelegate._invokeDlgt);
                this._invokeCurrZone =
                  zoneSpec &&
                  (zoneSpec.onInvoke
                    ? this.zone
                    : parentDelegate._invokeCurrZone);
                this._handleErrorZS =
                  zoneSpec &&
                  (zoneSpec.onHandleError
                    ? zoneSpec
                    : parentDelegate._handleErrorZS);
                this._handleErrorDlgt =
                  zoneSpec &&
                  (zoneSpec.onHandleError
                    ? parentDelegate
                    : parentDelegate._handleErrorDlgt);
                this._handleErrorCurrZone =
                  zoneSpec &&
                  (zoneSpec.onHandleError
                    ? this.zone
                    : parentDelegate._handleErrorCurrZone);
                this._scheduleTaskZS =
                  zoneSpec &&
                  (zoneSpec.onScheduleTask
                    ? zoneSpec
                    : parentDelegate._scheduleTaskZS);
                this._scheduleTaskDlgt =
                  zoneSpec &&
                  (zoneSpec.onScheduleTask
                    ? parentDelegate
                    : parentDelegate._scheduleTaskDlgt);
                this._scheduleTaskCurrZone =
                  zoneSpec &&
                  (zoneSpec.onScheduleTask
                    ? this.zone
                    : parentDelegate._scheduleTaskCurrZone);
                this._invokeTaskZS =
                  zoneSpec &&
                  (zoneSpec.onInvokeTask
                    ? zoneSpec
                    : parentDelegate._invokeTaskZS);
                this._invokeTaskDlgt =
                  zoneSpec &&
                  (zoneSpec.onInvokeTask
                    ? parentDelegate
                    : parentDelegate._invokeTaskDlgt);
                this._invokeTaskCurrZone =
                  zoneSpec &&
                  (zoneSpec.onInvokeTask
                    ? this.zone
                    : parentDelegate._invokeTaskCurrZone);
                this._cancelTaskZS =
                  zoneSpec &&
                  (zoneSpec.onCancelTask
                    ? zoneSpec
                    : parentDelegate._cancelTaskZS);
                this._cancelTaskDlgt =
                  zoneSpec &&
                  (zoneSpec.onCancelTask
                    ? parentDelegate
                    : parentDelegate._cancelTaskDlgt);
                ...
                const parentHasTask =
                  parentDelegate && parentDelegate._hasTaskZS;
              ...
              if (
                ...
                if (!nativeMicroTaskQueuePromise) {
                  if (global[symbolPromise]) {
                    nativeMicroTaskQueuePromise = global[symbolPromise].resolve(
                      0
                    );
                  }
                }
          ...
          Zone.__load_patch("ZoneAwarePromise", (global, Zone, api) => {
            ...
            function readableObjectToString(obj) {
              if (obj && obj.toString === Object.prototype.toString) {
                ...
                return (
                  (className ? className : "") + ": " + JSON.stringify(obj)
                );
              }
            ...
            const REJECTION_HANDLED_HANDLER = __symbol__(
                ...
                () => {
                  try {
                    ...
                    const isFinallyPromise =
                      !!chainPromise &&
                      symbolFinally === chainPromise[symbolFinally];
                    if (isFinallyPromise) {
            ...
            class ZoneAwarePromise {
              ...
              static allSettled(values) {
                const P =
                  this && this.prototype instanceof ZoneAwarePromise
                    ? this
                    : ZoneAwarePromise;
            ...
            if (!desc || desc.configurable) {
              ...
              desc.get = function () {
                ...
                return global[ZONE_AWARE_PROMISE]
                  ? global[ZONE_AWARE_PROMISE]
                  : global[symbolPromise];
              };
            ...
            Promise[
              Zone.__symbol__("uncaughtPromiseErrors")
          ...
          const ZONE_SYMBOL_ADD_EVENT_LISTENER = Zone.__symbol__(
            ADD_EVENT_LISTENER_STR
          );
          /** zoneSymbol removeEventListener */
          const ZONE_SYMBOL_REMOVE_EVENT_LISTENER = Zone.__symbol__(
          ...
          function patchPrototype(prototype, fnNames) {
            ...
            for (let i = 0; i < fnNames.length; i++) {
              ...
              if (delegate) {
                const prototypeDesc = ObjectGetOwnPropertyDescriptor(
                  prototype,
                  name
                );
                ...
                prototype[name] = ((delegate) => {
                  const patched = function () {
                    return delegate.apply(
                      this,
                      bindArguments(arguments, source + "." + name)
                    );
                  };
          ...
          const wrapFn = function (event) {
            ...
            if (!eventNameSymbol) {
              eventNameSymbol = zoneSymbolEventNames[event.type] = zoneSymbol(
                "ON_PROPERTY" + event.type
              );
            }
          ...
          function patchProperty(obj, prop, prototype) {
            ...
            if (
              obj.hasOwnProperty(onPropPatchedSymbol) &&
              obj[onPropPatchedSymbol]
            ) {
              return;
            }
            ...
            if (!eventNameSymbol) {
              eventNameSymbol = zoneSymbolEventNames[eventName] = zoneSymbol(
                "ON_PROPERTY" + eventName
              );
            }
              ...
              (function (prop) {
                if (typeof instance[prop] === "function") {
                  _global[className].prototype[prop] = function () {
                    return this[originalInstanceKey][prop].apply(
                      this[originalInstanceKey],
                      arguments
                    );
                  };
                } else {
            ...
            symbols.forEach((symbol) => {
              ...
              Object.defineProperty(dest, symbol, {
                ...
                set: function (value) {
                  if (
                    desc &&
                    (!desc.writable || typeof desc.set !== "function")
                  ) {
            ...
            setNative = patchMethod(
              ...
              (delegate) =>
                function (self, args) {
                  ...
                  if (
                    meta.cbIdx >= 0 &&
                    typeof args[meta.cbIdx] === "function"
                  ) {
          ...
          const globalSources = {};
          const EVENT_NAME_SYMBOL_REGX = new RegExp(
          ...
          function patchEventTarget(_global, apis, patchOptions) {
            ...
            const REMOVE_EVENT_LISTENER =
              (patchOptions && patchOptions.rm) || REMOVE_EVENT_LISTENER_STR;
            const LISTENERS_EVENT_LISTENER =
              (patchOptions && patchOptions.listeners) || "eventListeners";
            ...
            const PREPEND_EVENT_LISTENER_SOURCE =
            ...
            const invokeTask = function (task, target, event) {
              ...
              if (options && typeof options === "object" && options.once) {
                ...
                const delegate = task.originalDelegate
                  ? task.originalDelegate
                  : task.callback;
                target[REMOVE_EVENT_LISTENER].call(
                  target,
                  event.type,
                  delegate,
                  options
            ...
            const globalZoneAwareCallback = function (event) {
              ...
              const target = this || event.target || _global;
              const tasks =
                target[zoneSymbolEventNames$1[event.type][FALSE_STR]];
              if (tasks) {
            ...
            const globalZoneAwareCaptureCallback = function (event) {
              ...
              const target = this || event.target || _global;
              const tasks =
                target[zoneSymbolEventNames$1[event.type][TRUE_STR]];
              if (tasks) {
                // invoke all tasks which attached to current target with given event.type and capture = false
                // for performance concern, if task.length === 1, just invoke
                if (tasks.length === 1) {
            ...
            function patchEventTargetMethods(obj, patchOptions) {
              ...
              const eventNameToString =
                patchOptions && patchOptions.eventNameToString;
              // a shared global taskData to pass data for scheduleEventTask
              // so we do not need to create a new object just for pass some data
              const taskData = {};
              const nativeAddEventListener = (proto[
                zoneSymbolAddEventListener
              ] = proto[ADD_EVENT_LISTENER]);
              const nativeRemoveEventListener = (proto[
                zoneSymbol(REMOVE_EVENT_LISTENER)
              ] = proto[REMOVE_EVENT_LISTENER]);
              const nativeListeners = (proto[
                zoneSymbol(LISTENERS_EVENT_LISTENER)
              ...
              if (patchOptions && patchOptions.prepend) {
                nativePrependEventListener = proto[
              ...
              const customCancelGlobal = function (task) {
                ...
                if (!task.isRemoved) {
                  const symbolEventNames =
                    zoneSymbolEventNames$1[task.eventName];
                  let symbolEventName;
                  if (symbolEventNames) {
                    symbolEventName =
                      symbolEventNames[task.capture ? TRUE_STR : FALSE_STR];
                  }
                  const existingTasks =
                    symbolEventName && task.target[symbolEventName];
                  if (existingTasks) {
              ...
              const customSchedule = useGlobalCallback
                ? customScheduleGlobal
                : customScheduleNonGlobal;
              const customCancel = useGlobalCallback
                ? customCancelGlobal
                : customCancelNonGlobal;
              const compareTaskCallbackVsDelegate = function (task, delegate) {
                const typeOfDelegate = typeof delegate;
                return (
                  (typeOfDelegate === "function" &&
                    task.callback === delegate) ||
                  (typeOfDelegate === "object" &&
                    task.originalDelegate === delegate)
                );
              };
              const compare =
                patchOptions && patchOptions.diff
                  ? patchOptions.diff
              ...
              const makeAddListener = function (
                ...
                return function () {
                  ...
                  if (
                    !(!passiveSupported && typeof task.options === "boolean")
                  ) {
              ...
              proto[REMOVE_EVENT_LISTENER] = function () {
                ...
                const existingTasks =
                  symbolEventName && target[symbolEventName];
                if (existingTasks) {
                  for (let i = 0; i < existingTasks.length; i++) {
                    const existingTask = existingTasks[i];
                    if (compare(existingTask, delegate)) {
                      ...
                      if (existingTasks.length === 0) {
                        ...
                        if (typeof eventName === "string") {
                          const onPropertySymbol =
                            ZONE_SYMBOL_PREFIX + "ON_PROPERTY" + eventName;
                ...
                if (!eventName) {
                  ...
                  for (let i = 0; i < keys.length; i++) {
                    ...
                    if (evtName && evtName !== "removeListener") {
                      this[REMOVE_ALL_LISTENERS_EVENT_LISTENER].call(
                        this,
                        evtName
                      );
                    }
                    ...
                    if (tasks) {
                      ...
                      for (let i = 0; i < removeTasks.length; i++) {
                        ...
                        let delegate = task.originalDelegate
                          ? task.originalDelegate
                          : task.callback;
                        this[REMOVE_EVENT_LISTENER].call(
                          this,
                          eventName,
                          delegate,
                          task.options
              ...
              if (opts && opts.prototype) {
                callbacks.forEach(function (callback) {
                  ...
                  if (prototype.hasOwnProperty(callback)) {
                    const descriptor = api.ObjectGetOwnPropertyDescriptor(
                      prototype,
                      callback
                    );
                    if (descriptor && descriptor.value) {
                      descriptor.value = api.wrapWithCurrentZone(
                        descriptor.value,
                        source
                      );
                      api._redefineProperty(
                        opts.prototype,
                        callback,
                        descriptor
                      );
                    } else if (prototype[callback]) {
                      prototype[callback] = api.wrapWithCurrentZone(
                        prototype[callback],
                        source
                      );
                    }
          ...
          function filterProperties(target, onProperties, ignoreProperties) {
            ...
            return onProperties.filter(
              (op) => targetIgnoreProperties.indexOf(op) === -1
            );
          }
          ...
          function propertyDescriptorPatch(api, _global) {
            ...
            if (isBrowser) {
              ...
              patchFilteredProperties(
                ...
                ignoreProperties
                  ? ignoreProperties.concat(ignoreErrorProperties)
                  : ignoreProperties,
            ...
            const XMLHttpRequestEventTarget =
              _global["XMLHttpRequestEventTarget"];
          ...
          Zone.__load_patch("util", (global, Zone, api) => {
            ...
            const SYMBOL_BLACK_LISTED_EVENTS = Zone.__symbol__(
              "BLACK_LISTED_EVENTS"
            );
            const SYMBOL_UNPATCHED_EVENTS = Zone.__symbol__("UNPATCHED_EVENTS");
            if (global[SYMBOL_UNPATCHED_EVENTS]) {
              global[SYMBOL_BLACK_LISTED_EVENTS] =
                global[SYMBOL_UNPATCHED_EVENTS];
            }
              ...
              (delegate) =>
                function (self, args) {
                  ...
                  if (task && typeof task.type === "string") {
                    if (
                      task.state !== "notScheduled" &&
                      ((task.cancelFn && task.data.isPeriodic) ||
                        task.runCount === 0)
                    ) {
                      if (typeof id === "number") {
          ...
          function patchCustomElements(_global, api) {
            ...
            if (
              (!isBrowser && !isMix) ||
              !_global["customElements"] ||
              !("customElements" in _global)
            ) {
              return;
            }
            const callbacks = [
          ...
          Zone.__load_patch("XHR", (global, Zone) => {
            ...
            const XHR_ERROR_BEFORE_SCHEDULED = zoneSymbol(
            ...
            function patchXHR(window) {
              ...
              let oriAddListener =
                XMLHttpRequestPrototype[ZONE_SYMBOL_ADD_EVENT_LISTENER];
              let oriRemoveListener =
                XMLHttpRequestPrototype[ZONE_SYMBOL_REMOVE_EVENT_LISTENER];
              if (!oriAddListener) {
                const XMLHttpRequestEventTarget =
                    ...
                    if (
                      ...
                      if (loadTasks && loadTasks.length > 0) {
                        ...
                        task.invoke = function () {
                          ...
                          const loadTasks =
                            target[Zone.__symbol__("loadfalse")];
          ...
          Zone.__load_patch("PromiseRejectionEvent", (global, Zone) => {
            ...
            if (global["PromiseRejectionEvent"]) {
              Zone[
                zoneSymbol("unhandledPromiseRejectionHandler")
              ] = findPromiseRejectionHandler("unhandledrejection");
              Zone[
                zoneSymbol("rejectionHandledHandler")
