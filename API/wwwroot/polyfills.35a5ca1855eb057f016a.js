        ...
        (r =
          ...
          typeof (o = function () {
            ...
            !(function (e) {
              ...
              Zone.__load_patch("ZoneAwarePromise", (e, t, n) => {
                ...
                function Z(e, o, s) {
                  ...
                  if (e[g] === v) {
                    ...
                    if (
                      ...
                      if (
                        ((e[_] = s),
                        e[k] === k && o === b && ((e[g] = e[y]), (e[_] = e[m])),
                        o === T && s instanceof Error)
                      ) {
                        const e =
                          t.currentTask &&
                          t.currentTask.data &&
                ...
                class O {
                  ...
                  static all(e) {
                    return O.allWithCallback(e);
                  }
                  static allSettled(e) {
                    return (this && this.prototype instanceof O
                      ? this
                      : O
                    ).allWithCallback(e, {
            ...
            const d = Zone.__symbol__,
              ...
              _ = g ? window : void 0,
              k = (g && _) || ("object" == typeof self && self) || global,
              m = [null];
            function y(e, t) {
            ...
            function D(n, o, r) {
              ...
              const a = s.get,
                ...
                l = o.substr(2);
              let u = Z[l];
              u || (u = Z[l] = d("ON_PROPERTY" + l)),
                (s.set = function (e) {
                  let t = this;
                  t || n !== k || (t = k),
                    t &&
                      (t[u] && t.removeEventListener(l, S),
                      c && c.apply(t, m),
                      "function" == typeof e
                        ? ((t[u] = e), t.addEventListener(l, S, !1))
                        : (t[u] = null));
                }),
                (s.get = function () {
                  let e = this;
            ...
            function P(e, t, n) {
              if (t) for (let o = 0; o < t.length; o++) D(e, "on" + t[o], n);
              else {
                const t = [];
                for (const n in e) "on" == n.substr(0, 2) && t.push(n);
                for (let o = 0; o < t.length; o++) D(e, t[o], n);
              }
            }
            const C = d("originalInstance");
            function O(e) {
              const n = k[e];
              if (!n) return;
              (k[d(e)] = n),
                (k[e] = function () {
                  const t = y(arguments, e);
                  switch (t.length) {
                    case 0:
                      this[C] = new n();
                      break;
            ...
            function z(t, o, r) {
              ...
              const i = d(o);
              let a = null;
              if (s && !(a = s[i]) && ((a = s[i] = s[o]), v(s && e(s, o)))) {
                const e = r(a, i, o);
                (s[o] = function () {
                ...
                k = function (t) {
                  ...
                  if (o)
                    if (1 === o.length) _(o[0], n, t);
                      ...
                      const e = o.slice();
                      for (let o = 0; o < e.length && (!t || !0 !== t[B]); o++)
                        _(e[o], n, t);
                    }
                },
                m = function (t) {
                ...
                const O = s
                  ...
                  x = function (t, n, r, a, c = !1, h = !1) {
                    return function () {
                      ...
                      if (i && !i(t, d, p, arguments)) return;
                      const k = L && !!R && -1 !== R.indexOf(f),
                        m = C(arguments[2], k);
                      if (N)
                      ...
                      const x = s ? A : void 0;
                      x && (x.taskData = E);
                      const M = w.scheduleEventTask(D, d, x, r, a);
                      return (
                        (E.target = null),
                        x && (x.taskData = null),
                        v && (m.once = !0),
                        (L || "boolean" != typeof M.options) && (M.options = m),
                        (M.target = p),
                        (M.capture = y),
                        (M.eventName = f),
                        g && (M.originalDelegate = d),
                        h ? P.unshift(M) : P.push(M),
                        c ? p : void 0
                      );
                    };
                  };
            ...
            function ae(e, t) {
              ...
              if (E) {
                const e = window,
                  t = x ? [{ target: e, ignoreProperties: ["error"] }] : [];
                ie(e, re.concat(["messageerror"]), r ? r.concat(t) : r, n(e)),
                  ie(Document.prototype, re, r),
                  void 0 !== e.SVGElement && ie(e.SVGElement.prototype, re, r),
                  ie(Element.prototype, re, r),
                  ie(HTMLElement.prototype, re, r),
                  ie(HTMLMediaElement.prototype, J, r),
                  ie(HTMLFrameSetElement.prototype, X.concat(K), r),
                  ie(HTMLBodyElement.prototype, X.concat(K), r),
                  ie(HTMLFrameElement.prototype, Y, r),
                  ie(HTMLIFrameElement.prototype, Y, r);
                const o = e.HTMLMarqueeElement;
                o && ie(o.prototype, Q, r);
                const s = e.Worker;
                s && ie(s.prototype, oe, r);
              }
              const s = t.XMLHttpRequest;
              s && ie(s.prototype, ee, r);
              const i = t.XMLHttpRequestEventTarget;
              i && ie(i && i.prototype, ee, r),
                "undefined" != typeof IDBIndex &&
                  (ie(IDBIndex.prototype, te, r),
                  ie(IDBRequest.prototype, te, r),
                  ie(IDBOpenDBRequest.prototype, te, r),
                  ie(IDBDatabase.prototype, te, r),
                  ie(IDBTransaction.prototype, te, r),
                  ie(IDBCursor.prototype, te, r)),
                o && ie(WebSocket.prototype, ne, r);
            }
            Zone.__load_patch("util", (n, a, c) => {
              (c.patchOnProperties = P),
                (c.patchMethod = z),
                (c.bindArguments = y),
                (c.patchMacroTask = j);
              const f = a.__symbol__("BLACK_LISTED_EVENTS"),
                d = a.__symbol__("UNPATCHED_EVENTS");
              n[d] && (n[f] = n[d]),
                n[f] && (a[f] = a[d] = n[f]),
                (c.patchEventPrototype = V),
                (c.patchEventTarget = W),
                (c.isIEOrEdge = M),
                ...
                (n) =>
                  function (r, s) {
                    if ("function" == typeof s[0]) {
                      ...
                      return (
                        "number" == typeof n ? (i[n] = e) : n && (n[ce] = e),
                        n &&
                          n.ref &&
                          n.unref &&
            ...
            Zone.__load_patch("legacy", (e) => {
                        ...
                        function (e, n) {
                          ...
                          if (e[o]) return w.apply(e, n);
                          {
                            const t = {
                              ...
                              o = f("XMLHttpRequest.send", y, t, m, v);
                            e &&
                              !0 === e[l] &&
                              !t.aborted &&
                              o.state === k &&
                        ...
                        function (e, o) {
                          ...
                          if (r && "string" == typeof r.type) {
                            if (
                              ...
                              return;
                            r.zone.cancelTask(r);
                          } else if (!0 === t.current[T]) return Z.apply(e, o);
                        }
                    );
                })(e);
                const n = d("xhrTask"),
              ...
              Zone.__load_patch("PromiseRejectionEvent", (e, t) => {
                ...
                e.PromiseRejectionEvent &&
                  ((t[d("unhandledPromiseRejectionHandler")] = n(
                    "unhandledrejection"
                  )),
